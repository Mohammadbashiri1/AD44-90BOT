...
DEFAULT_CONFIG = {
    "host_usernames": ["44_90"],
    "admin_usernames": ["44_90"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "697b666172251d71779b4d94&invite")
    api_token = os.getenv("API_TOKEN", "4671fba5d9dd3424a0e9fe1cacc5cd84a4c3f5c2899720eb2d4ff71927c2136c")
